...
class SimulatorSource(ThermalSource):
    """160x120 synthetic temperature field with person, footprints, and abnormal spots."""
    ...
    def _insert_abnormal(self, temp: np.ndarray):
        temp[10:14, 10:14] = 90.0   # high
        temp[30:34, 50:54] = 5.0    # low
        temp[70:75, 90:95] = 160.0  # fire
